...
- 2026-07-25 dropped: Not real work: the auto-filing pipeline turned a worker's FOLLOW-UP annotation line into a task title. The referenced work exists and is tracked as dn-4ab9 on the donefile board (p2, claimed) — 'done' records a failing --test when a --commit already makes the close sufficient. Nothing to do here; the filing-pipeline bug is filed separately.
